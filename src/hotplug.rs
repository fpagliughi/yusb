...
/// any `yusb` function that takes a [`Device`]. It also safe to open a device and
...
pub trait Hotplug: Send {
    /// Callback for when a device is attached to the system.
